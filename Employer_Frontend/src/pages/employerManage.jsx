...
export default function EmployerDashboard({ collapsed, jobPosts }) {
  // ===== JOB POSTS =====
  ...
  useEffect(() => {
    setCvList([
      { id: 1, name: "Trần Nhật Dương", position: "Software Engineer", location: "Gò Vấp", priority: "high", status: "chua_xem", date: "2025-10-15", email: "duong.tran@email.com", emailSent: false },
      { id: 2, name: "Đào Duy Hảo", position: "UI/UX Designer", location: "Thủ Đức", priority: "low", status: "chua_xem", date: "2025-10-20", email: "hao.dao@email.com", emailSent: false },
      { id: 3, name: "Văn Phú Hiệu", position: "Data Analyst", location: "Thảo Điền", priority: "", status: "chua_xem", date: "2025-10-18", email: "hieu.van@email.com", emailSent: false },
      { id: 4, name: "Nguyễn Huỳnh Trọng Đức", position: "Software Engineer", location: "Quận 8", priority: "low", status: "chua_xem", date: "2025-10-22", email: "duc.nguyen@email.com", emailSent: false },
      { id: 5, name: "Nguyễn Văn A", position: "UI/UX Designer", location: "Bến Thành", priority: "high", status: "chua_xem", date: "2025-10-10", email: "a.nguyen@email.com", emailSent: false },
    ]);
  }, []);
        ...
        <div className="manage-posts-container">
          ...
          <div className="filter-bar" style={{ left: collapsed ? "5%" : "17.5%", transition: "left 0.3s ease" }}>
            ...
            <p className="cv-quick-stats">
              ...
              (<strong>{cvStats.dau}</strong> Đậu, 
              <strong> {cvStats.tuChoi}</strong> Từ chối, 
              <strong> {cvStats.daXem}</strong> Đã xem, 
              <strong> {cvStats.chuaXem}</strong> Chưa xem)
            </p>
          ...
          {/* CV List */}
          <div className="job-post-list" style={{ paddingTop: "250px" }}>
    ...
    return (
      <div className="manage-posts-container">
        <div className="no-results" style={{ paddingTop: '50px', margin: '0 auto', maxWidth: '600px' }}>
          ...
          <p>Bạn cần đăng tin tuyển dụng tại trang "Quản lý bài đăng" trước khi có thể xem CV ứng tuyển tại đây.</p>
        </div>
      </div>
    );
  }
