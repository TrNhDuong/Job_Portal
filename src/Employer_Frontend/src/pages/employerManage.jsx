// src/pages/employerManage.jsx
// --- PHIÊN BẢN SỬA LỖI "FLASH" (LƯỚT NHANH) KHI selectedCvIds RỖNG ---
...
export default function EmployerDashboard({ jobPosts }) {
  ...
  // --- THÊM STATE NÀY ĐỂ SỬA LỖI "FLASH" ---
  const [isMounted, setIsMounted] = useState(false);
  // ------------------------------------------
  const [sortOrder, setSortOrder] = useState("date_desc");

  useEffect(() => {
    // Dữ liệu CV mẫu (fake data)
    const fakeCVs = [
        // CVs cho "Software Engineer"
        { id: 1, name: "Trần Nhật Dương", position: "Software Engineer", location: "Gò Vấp", priority: "high", status: "chua_xem", date: "2025-11-10", email: "duong.tran@email.com", emailSent: false },
        { id: 4, name: "Nguyễn Huỳnh Trọng Đức", position: "Software Engineer", location: "Quận 8", priority: "low", status: "chua_xem", date: "2025-11-08", email: "duc.nguyen@email.com", emailSent: false },
        { id: 6, name: "Lê Văn Cười", position: "Software Engineer", location: "Quận 1", priority: "high", status: "dau_cv", date: "2025-11-05", email: "luyen.le@email.com", emailSent: true }, // Đã đậu, đã gửi mail
        { id: 7, name: "Hồ Thị Hẹ", position: "Software Engineer", location: "Tân Bình", priority: "", status: "tu_choi", date: "2025-11-01", email: "hy.ho@email.com", emailSent: false }, // Đã từ chối

        // CVs cho "UI/UX Designer"
        { id: 2, name: "Đào Duy Hảo", position: "UI/UX Designer", location: "Thủ Đức", priority: "low", status: "chua_xem", date: "2025-11-09", email: "hao.dao@email.com", emailSent: false },
        { id: 5, name: "Nguyễn Đình Chuẩn", position: "UI/UX Designer", location: "Bến Thành", priority: "high", status: "da_xem", date: "2025-11-07", email: "a.nguyen@email.com", emailSent: false }, // Đã xem
        { id: 8, name: "Phạm Thị Baby", position: "UI/UX Designer", location: "Bình Thạnh", priority: "", status: "dau_cv", date: "2025-11-04", email: "b.pham@email.com", emailSent: false }, // Đã đậu, CHƯA gửi mail

        // CVs cho "Data Analyst"
        { id: 3, name: "Văn Phú Hiệu", position: "Data Analyst", location: "Thảo Điền", priority: "", status: "chua_xem", date: "2025-11-06", email: "hieu.van@email.com", emailSent: false }
    ];

    setCvList(fakeCVs);
    //setIsLoadingCVs(false); // Tắt loading
